...
{
    public class WindowsZipArchiveService:IArchiveService
    {

        //Message catched from deletion or compress
        private string _message;

        //The archiver that will be used to do the compress
        ...
        public WindowsZipArchiveService()

        {
           ...
           ConfigurationManager.AppSettings["windowsArchiveExtension"];
            ...
            public bool FileOutPut(List<string> resultSet)
        {
            ...
            FileStream fileStream = new FileStream((outPutFilePath), FileMode.OpenOrCreate, FileAccess.ReadWrite, FileShare.ReadWrite);
            archiver = new ZipArchive(fileStream, ZipArchiveMode.Update);
        ...
        private bool AddToCompress(string fileName)
        {
            try
            {
             ...
             archiver.CreateEntryFromFile(filePath, fileName);
